...
var RoomMongoHelper = require('./RoomMongoHelper.js').RoomMongoHelper;
var RoomNumberMongoHelper = require('./RoomNumberMongoHelper.js').RoomNumberMongoHelper;
...
var RoomManager = {
	...
	//成功した場合はtrueを返す
	createNewRoom: function(rid, name, limit, now) {
